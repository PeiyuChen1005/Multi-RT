...
# camera
cam = FOVCamera(90.0,aspect_ratio)
print('origin:', cam.origin.x,cam.origin.y,cam.origin.z)
print('vertical:',cam.vertical.x,cam.vertical.y,cam.vertical.z)
print('horizontal:',cam.horizontal.x,cam.horizontal.y,cam.horizontal.z)
print('llc:',cam.lower_left_corner.x,cam.lower_left_corner.y,cam.lower_left_corner.z)
