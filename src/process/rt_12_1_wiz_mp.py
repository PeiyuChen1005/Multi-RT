...
look_at = Vec3(0, 0, -1)
dist_2_focus = (look_from - look_at).length()
# camera
cam = PositionalCamera(look_from, look_at, Vec3(0, 1, 0), 20, aspect_ratio,aperture=2.0, dist_to_focus=dist_2_focus)

# world
world = HitableList([
    Sphere(Vec3(0, 0, -1), 1, Lambertian(Vec3(0.1, 0.2, 0.5))),
